...
export const guestBookingConfirmations = pgTable("guest_booking_confirmations", {
  ...
  appointmentMode: text("appointment_mode").notNull().default("phone"),
  appointmentPhone: text("appointment_phone"),
  appointmentStreetAddress: text("appointment_street_address"),
  appointmentUnit: text("appointment_unit"),
  appointmentCity: text("appointment_city"),
  appointmentPostalCode: text("appointment_postal_code"),
  appointmentCountry: text("appointment_country"),
